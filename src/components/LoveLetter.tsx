            ...
            >
              ...
              <div className="prose prose-lg max-w-none font-serif">
                ...
                <p className="text-secondary/80 leading-relaxed mb-6">
                  From the moment we met in June 2023, my life has been filled
                  with warmth, joy, and a sense of home I never knew I was
                  missing. You are my comfort, my safe place, and the most
                  beautiful part of my days.
                </p>

                <p className="text-secondary/80 leading-relaxed mb-6">
                  With you, I've learned what it means to truly love someone, to
                  be vulnerable, and to love without reservation. Your presence
                  brings peace to my chaos, and your smile lights up even my
                  darkest moments.
                </p>

                <p className="text-secondary/80 leading-relaxed mb-6">
                  Thank you for being patient, for understanding, and for
                  choosing to build this beautiful life with me. Every day with
                  you is a gift, and I promise to cherish you, support you, and
                  love you with everything I have, be strong and never forget
                  that you are the most beautiful person I have ever met.
                </p>

                <p className="text-primary/90 leading-relaxed text-xl mt-8">
                  Forever yours,
                  <br />
                  <span className="font-dancing text-3xl mt-2 block">
                    Abdallah
                  </span>
                </p>
              </div>
